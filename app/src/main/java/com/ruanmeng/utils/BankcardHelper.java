...
public class BankcardHelper {
    ...
    private final static int[] bankBins = {
            ...
            623251, 628351, 627066, 627066, 627067, 627068, 627069, 412962, 412963, 415752, 415753, 622535,
            622536, 622538, 622539, 622983, 998800 };
    ...
    public static String getBankcardName(String cardnumber) {
        String charBin = cardnumber.substring(0, 6);
        int bin, index;
        bin = Integer.valueOf(charBin);
        index = binarySearch(bankBins, bin);
        if (index == -1 || index > bankNames.length) return null;

        return bankNames[index].substring(0, 4);
    }
    ...
    public static int binarySearch(int[] srcArray, int des) {
        ...
        while (low < high) {
            if (des == srcArray[low]) return low;
            low++;
        }
        return -1;
    }
