...
public class SuperTextView extends RelativeLayout {
    ...
    private int defaultBgColor = 0xFFFFFFFF;   //默认背景颜色（白色）
    private int defaultLineColor = 0xFFEDEDED; //边线的默认颜色
    private int defaultLinePadding = 0;        //线的左右边距

    private ImageView leftIconIV;  //左边图标
    private ImageView rightIconIV; //右边图标
    private int leftIconSize;      //左边图标的大小
    private int rightIconSize;     //左边图标的大小
    ...
    private int defaultLineHeight;  //默认边线的高度

    private int lineHeight;       //边线的高度
    ...
    private int defaultColor = 0xFF252525; //文字默认颜色
    ...
    public SuperTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        defaultLinePadding = dip2px(context, 10);
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        leftIconSize = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sLeftIconSize, 0);
        rightIconSize = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sRightIconSize, 0);
        ...
        lineHeight = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sLineHeight, defaultLineHeight= dip2px(mContext, 0.5f));
    ...
    private void initLayout() {
        ...
        switch (lineType) {
            ...
            case BOTTOM:
                ...
                break;
            case BOTH:
                if (topLineMargin != bottomLineMargin) {
                    initTopLine(topLineMargin);
                    initBottomLine(bottomLineMargin);
                } else {
    ...
    private void initTopLine(int lineMargin) {
        ...
        topLineParams = new LayoutParams(LayoutParams.MATCH_PARENT, lineHeight);
    ...
    private void initBottomLine(int lineMargin) {
        ...
        bottomLineParams = new LayoutParams(LayoutParams.MATCH_PARENT, lineHeight);
    ...
    private void initLeftIcon() {
        ...
        if (leftIconSize == 0) {
            ...
            leftImgParams = new LayoutParams(leftIconSize, leftIconSize);
        }
    ...
    private void initRightIcon() {
        ...
        if (rightIconSize == 0) {
            ...
            rightImgParams = new LayoutParams(rightIconSize, rightIconSize);
        }
     ...
     * @return 返回对象
     */
    public SuperTextView setTopMargin(int margin) {
        topLineMargin = margin;
     ...
     * @return 返回对象
     */
    public SuperTextView setBottomMargin(int margin) {
        bothLineMargin = margin;
